...
if __name__ == '__main__':
    ...
    parser.add_argument('--steps',          type=int,   default=2000)   # Number of steps during an entire episode for all processes combined
    ...
    parser.add_argument('--exp_name',       type=str,   default='newstate') # Name of data storage area
    parser.add_argument('--algo',           type=str,   default='ppo') # Name of data storage area
    
    args = parser.parse_args()

    print('Training {} with {} cores'.format(args.algo.upper(), args.cpu))
